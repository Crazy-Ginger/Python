...
dist = inf
print (len(l1Coords[0]))
print (len(l2Coords[0]))
print ()
# for i in range(len(l1Coords[0])):
    # for j in range(len(l2Coords[0])):
        # if l1Coords[0][i] == l2Coords[0][j] and l1Coords[1][i] == l2Coords[1][j] and i!= 0:
            # currDist = abs(l1Coords[0][i]) + abs(l1Coords[1][i])
            # if currDist < dist:
                # print (currDist)
                # dist = currDist
...
for i in range(len(l1Coords[0])):
    if l1Coords[0][i] in l2Coords[0] and l1Coords[1][i] in l2Coords[1]:
        for j in range(len(l2Coords[0])):
            if l1Coords[0][i] == l2Coords[0][j] and l1Coords[1][i] == l2Coords[1][j] and i!= 0:
                currDist = abs(l1Coords[0][i]) + abs(l1Coords[1][i])
                if currDist < dist:
